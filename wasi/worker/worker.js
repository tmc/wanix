...
async function runWasi(message) {
	...
	wasi.wasiImport.environ_sizes_get = (environ_count/*: number*/, environ_size/*: number*/)/*: number*/ => {
        ...
        buffer.setUint32(environ_count, wasi.env.length, true);
        let buf_size = 0;
        for (const environ of wasi.env) {
...
// We use the TinyGo wasm_exec.js even for big Go WASM
// to better work with wasip1 modules
